namespace Minate.DomainModel.Repositories.Interfaces
{
    ...
    public abstract class UserRepository : IRepository<int, User>
    {
        ...
        public abstract int Add(User entity);
        ...
        public abstract IEnumerable<User> Update(Predicate<User> predicate, User entity);
        ...
        public abstract IEnumerable<User> Delete(Predicate<User> predicate);

        /// <summary>
        /// Gets all the entities that are in the repository.
        /// </summary>
        public abstract IEnumerable<User> FetchAll();
        ...
        public abstract IEnumerable<User> FetchBy(Predicate<User> predicate);
